...
if __name__ == "__main__":
    while True:
        ...
        if try_again != "yes":
            break
"""
Enter th enumber of drill holes(nodes): 5
Enter the distance between node 1 and node 1: 5
Enter the distance between node 1 and node 2: 2
Enter the distance between node 1 and node 3: 3
Enter the distance between node 1 and node 4: 6
...
Enter the distance between node 2 and node 3: 5
Enter the distance between node 2 and node 4: 8
Enter the distance between node 2 and node 5: 9
Enter the distance between node 3 and node 1: 7
Enter the distance between node 3 and node 2: 2
Enter the distance between node 3 and node 3: 5
Enter the distance between node 3 and node 4: 4
Enter the distance between node 3 and node 5: 2
Enter the distance between node 4 and node 1: 5
Enter the distance between node 4 and node 2: 8
Enter the distance between node 4 and node 3: 7
Enter the distance between node 4 and node 4: 1
Enter the distance between node 4 and node 5: 2
Enter the distance between node 5 and node 1: 5
Enter the distance between node 5 and node 2: 3
Enter the distance between node 5 and node 3: 6
Enter the distance between node 5 and node 4: 4
Enter the distance between node 5 and node 5: 9
Optimal order of drilling:  [1, 4, 5, 2, 3, 2, 1]
Optimal cost of drilling:  20.0
Do you want to try again with different number of node? (yes/no):
"""
